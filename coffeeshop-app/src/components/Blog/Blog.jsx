...
const Blog = () => {
  return (
    <div className="mb-24">
        <div className="px-6 md:px-12 mx-16">
      <div className="flex justify-center items-center gap-3">
        <img src="./cb.png" alt="" className="w-6 h-6" />
        <p className="text-[22px] font-semibold text-[#3f271e] font-caudex">OUR BLOG</p>
      </div>
          ...
          >
            <div className="overflow-hidden">
              <img
                src={post.image}
                alt={post.title}
                className="w-full h-[18rem] object-cover transition-transform duration-300 ease-in-out transform hover:scale-110"
              />
            </div>
            ...
            <div className="p-6">
              <h2 className="text-[28px] font-bold font-caudex mt-4 mb-2 leading-tight">
                {post.title}
              </h2>
              <p className="text-gray-600 font-caudex mb-4 mt-3">
                {post.description}
              </p>
              <button className="border-b-[3px] font-semibold border-b-[#3f271e] text-[#3f271e]">
                READ MORE
              </button>
            </div>
          </div>
    ...
    <div className="relative">
        <img src="./an-img-01.png" alt="" className="absolute animate-bounce bottom-[20rem] right-1" />
        </div>
    </div>
  );
};

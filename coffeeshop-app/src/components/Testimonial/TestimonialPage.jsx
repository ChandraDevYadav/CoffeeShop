  ...
  return (
    ...
    >
      ...
      <div className="overflow-hidden relative w-full flex items-center justify-center py-10">
        {/* Testimonials */}
        <div className="grid grid-cols-2 gap-10 w-full mx-28">
          {/* First Testimonial */}
          ...
          <img src={testimonials[currentIndex].image} alt="" className='w-20 h-20' />
            <div>
            <h2 className="text-[1.8rem] font-semibold text-[#3f271e] font-caudex">{testimonials[currentIndex].name}</h2>
          ...
          {testimonials[currentIndex + 1] && (
            <div className="bg-white bg-opacity-90 p-6 rounded-lg shadow-md border">
              ...
              <div>
              <h2 className="text-[1.8rem] text-[#3f271e] font-semibold font-caudex">{testimonials[currentIndex + 1].name}</h2>
      ...
      {/* Arrow Buttons */}
      <div className={`absolute top-[100%] left-0 right-0 flex justify-center transform -translate-y-1/2 transition-opacity duration-300`}>
        <button
          className="bg-white text-black p-2 ml-4 rounded-full hover:bg-[#6f3727]"
          onClick={prevSlide}
        >
          <img src="./square.png" className='w-3 h-3' alt="" />
        </button>
        <button
          className="bg-white text-black mr-4 p-2 rounded-full hover:bg-[#6f3727]"
          onClick={nextSlide}
        >
          <img src="./square.png" className='w-3 h-3' alt="" />
        </button>

...
const ImageGallery = () => {
  const images = [
    ...
    { id: 5, src: "co5.jpg", alt: "Gallery Image 5" },
    { id: 6, src: "co6.jpg", alt: "Gallery Image 6" },
    { id: 7, src: "co7.jpg", alt: "Gallery Image 7" },
    { id: 8, src: "crousel2.jpg", alt: "Gallery Image 8" },
    { id: 9, src: "crousel1.jpg", alt: "Gallery Image 9" },
    { id: 10, src: "crousel3.jpg", alt: "Gallery Image 10" },
  ];
  ...
  return (
    <div className="pb-12">
      ...
      {/* Gallery grid */}
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-5 mx-4 sm:mx-10 md:mx-28">
      ...
      {selectedImageIndex !== null && (
        <div className="fixed inset-0 bg-black bg-opacity-80 flex justify-center items-center z-50">
          <div className="relative max-w-3xl w-full p-4">
            {/* Close Button */}
            <button
              className="absolute top-4 right-8 text-white text-2xl font-bold cursor-pointer"
              onClick={closeModal}
            >
              &times;
            </button>

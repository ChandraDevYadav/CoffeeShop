        ...
        {teaList.map((item) => (
          <div key={item.id} className="flex flex-col md:flex-row justify-center items-center">
            <div className="flex justify-center items-center gap-3">
              ...
              <div>
                <p className="text-[1.5rem] md:text-[2rem] font-semibold font-caudex">{item.name}</p>
                <p className="font-caudex text-gray-500 text-sm md:text-base">{item.description}</p>
              </div>
              <div className="border-t-4 border-dotted border-t-black w-16 md:w-20 mx-4 md:mx-6"></div>
              <div>
                <p className="text-black font-bold text-lg md:text-2xl">RS {item.price}</p>
              </div>
            </div>
          </div>
        ))}
